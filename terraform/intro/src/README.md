...
для этого необходимо добавить строку **force_remove** 

>force_remove (Логическое значение) Если true, то изображение удаляется принудительно при уничтожении ресурса.

<a href="https://docs.comcloud.xyz/providers/kreuzwerker/docker/latest/docs/resources/image">Ссылка на источник</a>

в нашем коде данной комманды нет
